...
<td class="header" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 25px 0; text-align: center;">
        <a href="https://believer.io" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
            <img src="https://believer.io/images/logo-light.png" />
        </a>
    </td>
</tr>
<!-- Email Body --><tr>
...
<td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
    ...
    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Sharing is rewarding, with <a href="https://believer.io/{{ $brandslug }}">Believer</a> – a word-of-mouth loyalty program that rewards you and supports local charities for promoting brands and local businesses you love. </p>
...
<td class="content-cell" align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
    <p style="font-family: Avenir, Helvetica, sans-serif;box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">&copy; <?php echo date('Y'); ?> Culturebrand, Inc. All rights reserved.</p>
</td>
</tr></table>
</td>
</tr>
